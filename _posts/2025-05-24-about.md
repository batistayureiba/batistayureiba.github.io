...
Hola, soy Yureiba Batista. Mi base sólida se encuentra en la Ingeniería de Operaciones y la Administración de Bases de Datos, donde mi foco principal ha sido asegurar la integridad, disponibilidad y rendimiento del núcleo (core) tecnológico.

Mi expertise profesional me permite gestionar sistemas robustos de Bases de Datos (SQL Server, PostgreSQL, MySQL), una base invaluable que me permite entender profundamente la calidad y la estructura del dato. Esto me capacita para aplicar conceptos de Data Warehousing en mi formación autodidacta y proyectos prácticos.

En roles de soporte y gestión de incidencias Nivel 2, he aprendido a actuar como un recurso clave para la continuidad del servicio en entornos de alta criticidad, como el sector financiero. Esta visión me permite ir más allá del troubleshooting reactivo y enfocarme en la automatización para mejorar la calidad y la velocidad de los procesos dentro del producto.

Mi Enfoque Práctico en la Optimización: Mi metodología se basa en identificar los desafíos operativos y aplicar soluciones de scripting y automatización. He desarrollado habilidades prácticas en Python, Apache Airflow y Bash para diseñar prototipos de flujos ETL/ELT eficientes. Esto se traduce en una operatividad del producto más ágil y efectiva, garantizando que los datos sean confiables y accesibles.

Evolución Continua y Potencial Estratégico: Mi transición hacia la Ingeniería de Datos es intencional y está respaldada por una formación constante:

Certificado Profesional de Ingeniería de Datos IBM (En Curso).

Especialización en Power BI (En Curso). * Inteligencia de Negocios e Indicadores de Gestión – Atrache Consultores (2018).

Busco aplicar esta combinación única de expertise operativo comprobado y conocimiento de vanguardia autodidacta en un entorno que me permita crecer como Ingeniera de Datos, mientras aporto valor inmediato en la optimización de procesos operativos.

Cierre y Llamada a la Acción (CTA Inclusiva):
Si tienes un proyecto que valora una base operativa robusta, o buscas optimizar la eficiencia del producto a través de datos estratégicos:

💡 Conectemos para conversar sobre cómo mi expertise en Operaciones y mi potencial en Data Engineering pueden aportar valor inmediato y construir juntos.
