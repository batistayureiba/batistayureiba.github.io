...
Data & Cibersegurity - OCT 2023.
> Blockquotes are very handy in email to emulate reply text.

Relational Database Administration (DBA) - DEC 2023.
> Blockquotes are very handy in email to emulate reply text.

Introduction to Data Engineering - JAN 2024.
> Blockquotes are very handy in email to emulate reply text.
> 
Python for Data Science, AI & Development - MAY 2024.
> Blockquotes are very handy in email to emulate reply text.

Introduction to Relational Database (RDBMS) - SEP 2024.
> Blockquotes are very handy in email to emulate reply text.

Python Project for Data Engineering - OCT - 2024.
> Blockquotes are very handy in email to emulate reply text.

Python Project for Data Science - NOV - 2024.
> Blockquotes are very handy in email to emulate reply text.

Databases and SQL for Data Science with Python - DEC 2024.
> Blockquotes are very handy in email to emulate reply text.

Hands-on Introduction to Linux Commands and Shell Scripting - MAY 2025.
> Blockquotes are very handy in email to emulate reply text.
