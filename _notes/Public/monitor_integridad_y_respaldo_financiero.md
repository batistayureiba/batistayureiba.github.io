...
![Fig 1. Pipeline de ingesta automatizada ejecutando validaciones de esquema y carga optimizada en la nube.](/assets/img/projects/pipeline_seguros.png)
...
![Fig 2. Visualización analítica de Market Share institucional; integración de microdatos de la Superfinanciera para la determinación del nivel de respaldo y solvencia de aseguradoras en tiempo real.](/assets/img/projects/dashboard_analitico_seguros.png)
...
![Fig 3. Interfaz de consulta de activos normalizados; ejecución de lógica de Type Casting sobre el histórico de valoraciones comerciales y mapeo dinámico de especificaciones técnicas (Cilindraje, Peso, Potencia).](/assets/img/projects/ficha_tecnica_seguros.png)
